...
const NewsLetter = () => {
  return (
    ...
    md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            ...
            <Title title="Stay Inspired" subTitle="Subscribe for exclusive offers, 
            travel inspiration, and hotel updates. Discover unforgettable stays and curated experiences with EliteStays." />
