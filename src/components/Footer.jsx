    ...
    <div className='bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                    EliteStays offers curated hotels, luxury resorts, and exclusive getaways. 
                    Discover comfort, style, and unforgettable experiences at handpicked destinations around the world.
                    </p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} EliteStays. All rights reserved.</p>
