...
const HotelCard = ({room, index}) => {
  return (
    <Link to={'/rooms/'+room._id} onClick={()=> scrollTo(0,0)} key={room._id}>
        <img src={room.images[0]} alt="" className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90
        ...
        <div className='p-4 pt-5'>
            ...
            <div className='flex-items-center justify-between mt-4'>
                ...
                rounded hover:bg-gray-50 transition-all cursir-pointer' >Book Now</button>
            </div>
        </div>
    </Link>
  );
