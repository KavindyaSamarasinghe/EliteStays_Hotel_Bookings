...
const RoomDetails = () => {
    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            {/* Room Highlights and Price - Fixed to display side by side */}
            <div className='flex flex-col md:flex-row md:justify-between items-start mt-10'>
                ...
                {/* Room Price - Now aligned to the right side */}
            ...
            <div className='mt-25 space-y-4'>
                ...
                <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                    <p>
                    Experience comfort and style in our spacious hotel rooms, designed for 
                    relaxation and convenience. From deluxe suites to cozy retreats, each room 
                    features modern amenities, comfortable beds, and inviting decor. Whether you’re 
                    here for business or leisure, EliteStays ensures a restful, enjoyable stay with beautiful 
                    views, warm service, and everything you need to feel at home.
