...
const Dashboard = () => {
  ...
  const [dashboardData, setDasboardData] = useState(dashboardDummyData)



  return (
    <div>
      <Title align='left' font='outfit' title='Dashboard' subTitle='Manage your hotel 
      bookings, track guest reservations, update room availability, and monitor 
      performance — all from your EliteStays owner dashboard.' />
